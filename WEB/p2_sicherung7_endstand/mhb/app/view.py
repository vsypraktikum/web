...
#----------------------------------------------------------
    ...
    #-------------------------------------------------------
    def createTemplate_student_p(self, template_spl, data_opl, data_opl2):
    #-------------------------------------------------------
        # Auswertung mit templates
        template_o = self.lookup_o.get_template(template_spl)
        # mit der Methode render wird das zuvor 'übersetzte' Template ausgeführt
        ...
        markup_s = template_o.render(data_o = data_opl, data_l = data_opl2)
        return markup_s    
    
    #-------------------------------------------------------
    def createTemplate3_p(self, template_spl, data_opl, data_opl2, data_opl3):
    #-------------------------------------------------------
        # Auswertung mit templates
        template_o = self.lookup_o.get_template(template_spl)
        # mit der Methode render wird das zuvor 'übersetzte' Template ausgeführt
        ...
        markup_s = template_o.render(data_o = data_opl, data_m = data_opl2, data_l = data_opl3)
        return markup_s

    #-------------------------------------------------------
    def createTemplate_modul_p(self, template_spl, data_opl, data_opl2, data_opl3, benutzer):
    #-------------------------------------------------------
        # Auswertung mit templates
        template_o = self.lookup_o.get_template(template_spl)
        # mit der Methode render wird das zuvor 'übersetzte' Template ausgeführt
        ...
        markup_s = template_o.render(data_o = data_opl, data_m = data_opl2, data_l = data_opl3, modulv = benutzer)
        return markup_s
    ...
    #-------------------------------------------------------
    def createList_studiengaenge_student_px(self, data_opl, data_opl2):
    #-------------------------------------------------------
        return self.createTemplate_student_p('liste_studiengaenge_student.tpl', data_opl, data_opl2)
    ...
    #-------------------------------------------------------
    def createList_studiengaenge_module_px(self, data_opl, data_opl2, data_opl3):
    #-------------------------------------------------------
        return self.createTemplate3_p('liste_studiengaenge_vs.tpl', data_opl, data_opl2, data_opl3)
  
    #-------------------------------------------------------
    def createList_studiengaenge_lv_module_px(self, data_opl, data_opl2, data_opl3, benutzer):
    #-------------------------------------------------------
        return self.createTemplate_modul_p('liste_studiengaenge_vm.tpl', data_opl, data_opl2, data_opl3, benutzer)
