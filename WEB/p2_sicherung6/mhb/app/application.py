...
#----------------------------------------------------------
    ...
    #-------------------------------------------------------
        ...
        for i in range(0, len(data_b)):
            ...
            if (benutzer == data_b[str(i)][0]) and (kennwort == data_b[str(i)][1]): 
                ...
                if (data_b[str(i)][2]=="vm"):
                    #return "Hier ist Verantwortlicher Module" 
                    return self.createList_studiengaenge_lv_module_p()
                elif (data_b[str(i)][2]=="vs"):
    ...
    #-------------------------------------------------------
        data_o = {}
        return self.view_o.createList_modulhandbuch_px(id, data_o)
    @cherrypy.expose
    ...
    #-------------------------------------------------------
        ...
        return self.view_o.createList_studiengaenge_student_px(data_o)    
    ...
    #-------------------------------------------------------
        ...
        return self.view_o.createList_studiengaenge_module_px(data_o, data_m)
    ...
    #-------------------------------------------------------
        ...
        #data_l = self.db_o.read_lehrveranstaltungen_px()
        data_m = self.db_o.read_module_px()
        return self.view_o.createList_studiengaenge_lv_module_px(data_o, data_m)
    ...
    #Erstellung des Forms für die Studiengänge
        ...
        # mit diesen Daten Markup erzeugen
        return self.view_o.createForm_studiengaenge_px(id_spl, data_o)     
