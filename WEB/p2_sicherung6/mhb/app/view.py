...
#----------------------------------------------------------
    ...
    #-------------------------------------------------------
    def createList_modulhandbuch_px(self, id_spl, data_opl):
    #-------------------------------------------------------
        #Generierung des Loginforms für die Anmeldung mit dem Benutzernamen
        return self.createTemplate_p('liste_modulhandbuch.tpl', data_opl)    
    ...
    #-------------------------------------------------------
        return self.createTemplate2_p('liste_studiengaenge_module.tpl', data_opl, data_opl2)
  
    #-------------------------------------------------------
    def createList_studiengaenge_lv_module_px(self, data_opl, data_opl2):
    #-------------------------------------------------------
        return self.createTemplate2_p('liste_studiengaenge_lv_module.tpl', data_opl, data_opl2)

    #-------------------------------------------------------
    def createForm_studiengaenge_px(self, id_spl, data_opl):
    #-------------------------------------------------------
    #Generierung des Speichern/Bearbeitungsforms für die Studiengänge
        ...
        markup_s += self.createTemplate_p('liste_lehrveranstaltungen.tpl', data_opl[5])
