...
#----------------------------------------------------------
   ...
   def __init__(self):
   #-------------------------------------------------------
      super(ProjektDatabase_cl, self).__init__('Projekt')
...
#----------------------------------------------------------
   ...
   def __init__(self):
   #-------------------------------------------------------
      super(FehlerDatabase_cl, self).__init__('Fehler')
...
#----------------------------------------------------------
   ...
   def __init__(self):
   #-------------------------------------------------------
      super(KomponenteDatabase_cl, self).__init__('Komponenten')
...
class MitarbeiterDatabase_cl(Database_cl):
   ...
   def __init__(self):
      # -------------------------------------------------------
      super(MitarbeiterDatabase_cl, self).__init__('Mitarbeiter')
...
class KategorieDatabase_cl(Database_cl):
   ...
   def __init__(self):
      # -------------------------------------------------------
      super(KategorieDatabase_cl, self).__init__('Kategorie')
...
class AuswertungProjekteDatabase_cl(Database_cl):
   ...
   def __init__(self):
      # -------------------------------------------------------
      super(AuswertungProjektDatabase_cl, self).__init__('AuswertungProjekte')
...
class AuswertungKategorieDatabase_cl(Database_cl):
   ...
   def __init__(self):
      # -------------------------------------------------------
      super(AuswertungKategorieDatabase_cl, self).__init__('AuswertungKategorie')
