...
<html>
	...
	<body>
		<div><p>${alert}</p></div>
		<form id="idWTForm" action="/savePPA" method="POST">
			<input type="hidden" value="${key_s}" id="id_s" name="id_s" />
			<div>
				<label for="pptitel">pptitel</label></div>
				<input type="text" value="${data_o['pptitel']}" id="pptitel" name="pptitel" required />
			</div>
			<div>
			...
			<div>
				<label for="firma">Firma-ID</label>
				<input type="text" value="${data_o['firmaid']}" id="firmaid" name="firmaid" required />
			</div>
			<div>
			...
			<div>
				...
				<input type="hidden" value="${data_o['lehrendenid']}" id="lehrendenid" name="lehrendenid" required />
			</div>
			<div>
				<!--<label for="matrikelid">Matrikelidt</label>-->
				<input type="hidden" value="${data_o['matrikelid']}" id="matrikelid" name="matrikelid" required />
			</div>
			<div>
				<!--<label for="anfangsdatum">Anfangsdatum</label>-->
				<input type="hidden" value="${data_o['anfangsdatum']}" id="anfangsdatum" name="anfangsdatum" required />
			</div>
			<div>
				<!--<label for="enddatum">Enddatum</label>-->
				<input type="hidden" value="${data_o['enddatum']}" id="enddatum" name="enddatum" required />
			</div>
