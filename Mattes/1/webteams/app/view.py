...
# ----------------------------------------------------------
    ...
    # -------------------------------------------------------
        ...
        for loop_i in range(0, 15):
            ...
            markup_s += lineT_o.safe_substitute(name1_s=data_a[0]  # HIER m�ssen Sie eine Erg�nzung vornehmen
                                                , vorname1_s=data_a[1]
                                                , matrnr1_s=data_a[2]
                                                , sem1_s=data_a[3]
                                                , name2_s=data_a[4]
    ...
    # -------------------------------------------------------
        ...
        markup_s += lineT_o.safe_substitute(name1_s=data_opl[0]  # HIER m�ssen Sie eine Erg�nzung vornehmen
